...
class View(ft.UserControl):
    ...
    def load_interface(self):
        ...
        row1=ft.Row([ft.Container(None,width=250),
                     ...
                     ft.Container(self._btnAnalizza,width=250)], alignment=ft.MainAxisAlignment.CENTER)
        ...
        row2 = ft.Row([ft.Container(None, width=250),
                       ...
                       ft.Container(self._btnConnessi, width=250)], alignment=ft.MainAxisAlignment.CENTER)
